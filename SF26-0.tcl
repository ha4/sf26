...
proc cmd_showex {showit} {
	if { $showit } {
	   grid .toolbar2.hr2
	   grid .toolbar2.lsk .toolbar2.nSk
	   grid .toolbar2.lSd .toolbar2.nSd
	   grid .toolbar2.lSi .toolbar2.nSin
	   grid .toolbar2.lSo .toolbar2.nSout
	   grid .toolbar2.lSc .toolbar2.nSc
	   grid .toolbar2.lCv .toolbar2.vC
	   grid .toolbar2.lCti .toolbar2.vTinmax
	   grid .toolbar2.lCto .toolbar2.vToutmax
	   grid .toolbar2.lAlph .toolbar2.vAlpha
	} else {
	   grid forget .toolbar2.hr2
	   grid forget .toolbar2.lsk
	   grid forget .toolbar2.nSk
	   grid forget .toolbar2.lSd
	   grid forget .toolbar2.nSd
	   grid forget .toolbar2.lSi
	   grid forget .toolbar2.nSin
	   grid forget .toolbar2.lSo
	   grid forget .toolbar2.nSout
	   grid forget .toolbar2.lSc
	   grid forget .toolbar2.nSc
	   grid forget .toolbar2.lCv
	   grid forget .toolbar2.vC
	   grid forget .toolbar2.lCti 
	   grid forget .toolbar2.vTinmax
	   grid forget .toolbar2.lCto 
	   grid forget .toolbar2.vToutmax
	   grid forget .toolbar2.lAlph
	   grid forget .toolbar2.vAlpha
	}
}
